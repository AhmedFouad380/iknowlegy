...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">{{__('lang.Packages')}}</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.percent')}} </th>
                            <th class="min-w-125px">{{__('lang.cash')}} </th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Packages.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'cash', name: 'cash', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Packages')}}",

        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-Pages')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="type" class="form-control">
                                    <option  @if($employee->type == 'header') selected @endif value="header">{{__('lang.header')}}</option>
                                    <option  @if($employee->type == 'footer') selected @endif  value="footer">{{__('lang.footer')}}</option>
                                </select>

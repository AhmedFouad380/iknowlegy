...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/Pages') }}" class="text-gray-600 text-hover-primary">{{__('lang.PromoCode')}}</a>
        </li>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-PromoCode')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <option @if($employee->type == 'cash' ) selected @endif value="cash">{{__('lang.cash')}}</option>
                                <option  @if($employee->type == 'percent' ) selected @endif value="percent">{{__('lang.percent')}}</option>
                                </select>
                                    <!--end::Input-->
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('lang.max_used')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="max_used" value="{{$employee->max_used}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder=""  required/>
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('lang.start_at')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="datetime-local" name="start" value="{{$employee->start}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder=""  required/>
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('lang.end_at')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="datetime-local" name="end" value="{{$employee->end}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder=""  required/>

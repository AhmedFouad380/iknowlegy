...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/Lessons') }}" class="text-gray-600 text-hover-primary">{{__('lang.Lessons')}}</a>
        </li>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-Lesson')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="sort" value="{{$employee->sort}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"

...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/HowToUse') }}" class="text-gray-600 text-hover-primary">{{__('lang.HowToUse')}}</a>
        </li>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-HowToUse')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="card">
                                            <div class="card-block">
                                                ...
                                                <div class="controls">
                                                    <input type="file" id="input-file-now" class="dropify"  name="video" data-default-file="{{$employee->video}}"   data-validation-required-message="{{trans('word.This field is required')}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('lang.sort')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="sort" value="{{$employee->sort}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"

...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3"> @if($type == 'student'){{__('lang.HowToUseStudent')}} @else {{__('lang.HowToUseInstructor')}} @endif</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('HowToUse.datatable.data') }}',
                    data: {
                        id:"{{$type}}",
                    }
                },
                columns: [
                    ...
                    {data: 'ar_name', name: 'ar_title', "searchable": true, "orderable": true},
                    {data: 'en_name', name: 'en_title', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-HowToUse/'.$type)}}",

...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">{{__('lang.CareersCategories')}}</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('CareersCategories.datatable.data') }}',
                    data: {
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-CareersCategories')}}",

        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">{{__('lang.new_add')}}</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post"  enctype="multipart/form-data" action="{{url('store-Instructor')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                    ...
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="card">
                                            <div class="card-block">
                                                ...
                                                <div class="controls">
                                                    <input type="file" id="input-file-now" class="dropify"  name="image" data-default-file=""  required data-validation-required-message="{{trans('word.This field is required')}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input id="txtPhone" type="text" name="code"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="{{__('lang.country_code')}}" value="{{old('country_code')}}" required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <input type="tel" name="phone"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="{{__('lang.phone')}}" value="{{old('phone')}}" required/>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="address"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="{{__('lang.address')}}" value="" required/>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <textarea rows="4" type="text" name="about"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                          placeholder="{{__('lang.about')}}" >  </textarea>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->

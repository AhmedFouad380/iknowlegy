...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">{{__('lang.Instructors')}}</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
{{--        <li class="breadcrumb-item text-gray-500">{{__('lang.students')}}</li>--}}
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Instructor.datatable.data') }}',
                    data: {
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Instructor')}}",

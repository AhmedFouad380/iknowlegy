...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/Internship_setting') }}" class="text-gray-600 text-hover-primary">{{__('lang.Internships')}}</a>
        </li>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-Internship')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="ar_company"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="" value="{{$employee->ar_company}}"  required/>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <input type="text" name="en_company"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="" value="{{$employee->en_company}}"  required/>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-control"  required id="subcat" name="city_id">
                                    @foreach($subCategroy->where('is_active','active')->get() as $cat)
                                        <option @if($cat->id == $employee->city_id) selected @endif value="{{$cat->id}}">{{$cat->title}}</option>
                                    @endforeach

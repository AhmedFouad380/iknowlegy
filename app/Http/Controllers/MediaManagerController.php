...
class MediaManagerController extends Controller
{
    ...
    public function index()
    {
        ...
        $medias = MediaManager::where('user_id', Auth::guard('instructor')->id())->latest()->get();
    ...
    {
        $medias = MediaManager::where('user_id', Auth::guard('instructor')->id())->latest()->get();
        return view('admin.media.main', compact('medias'));
    }

    public function slide()
    {
        $medias = MediaManager::where('user_id', Auth::guard('instructor')->id())->latest()->get();
        return view('admin.media.media_slide', compact('medias'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $media->user_id = Auth::guard('instructor')->id();
        ...
        if ($request->hasFile('image')) {
            ...
            MediaManager::find($media->id)->update([
                'image' => upload($request->image, 'media_manager'),
                'alt' => 'pdf'
                ]);
        }
    ...
    public function show()
    {
        $medias = MediaManager::latest()->get();
         return view('admin.media.main_modal', compact('medias'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.media.edit', compact('single_media'));
    }
    ...
    public function filter(Request $request, $type)
    {
        ...
        $filterDatas = MediaManager::where('type', $request->type)->where('user_id', Auth::guard('instructor')->id())->get();
        $checkData = MediaManager::where('type', $request->type)->where('user_id', Auth::guard('instructor')->id())->count();
        $dataSend = '';
        ...
        return $dataSend;
            ...
            $filterDatas = MediaManager::where('user_id', Auth::guard('instructor')->id())->get();
            $checkData = MediaManager::where('user_id', Auth::guard('instructor')->id())->count();
